...
public class SqlBuilder3Test {
  ...
  public void flattenedParams() throws Exception {
    assertEquals("", SqlBuilder3.formatSeparated(SqlBuilder3.flattenedParams(), "|"));
    assertEquals("", SqlBuilder3.formatSeparated(SqlBuilder3.flattenedParams((Object[]) null), "|"));
    assertEquals("5", SqlBuilder3.formatSeparated(SqlBuilder3.flattenedParams(5), "|"));
    assertEquals("1|2|3", SqlBuilder3.formatSeparated(SqlBuilder3.flattenedParams(1, 2, 3), "|"));
    assertEquals("1|10|11|3", SqlBuilder3.formatSeparated(SqlBuilder3.flattenedParams(1, new Integer[] { 10, 11 }, 3), "|"));
  }
